...
--
-- Host: localhost    Database: m_salary
-- ------------------------------------------------------
...
--
-- Current Database: `m_salary`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `m_salary` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `bonus` (
  ...
  CONSTRAINT `bonus_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_info` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-10-08 17:11:37
